...
public class MagneticFieldLogger extends SensorLogger implements SensorEventListener {
    String TAG = MagneticFieldLogger.class.toString();

    public MagneticFieldLogger(String sensor, Function<float[], Void> callback)  {
