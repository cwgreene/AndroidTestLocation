...
public class AccelerometerLogger extends SensorLogger implements SensorEventListener {
    String TAG = AccelerometerLogger.class.toString();

    public AccelerometerLogger(String sensor, Function<float[], Void> callback) {
